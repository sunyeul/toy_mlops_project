...
def featurization():
    ...
    train_data = pd.read_csv('./data/raw/train_data.csv', header=None, dtype=float).values
    test_data = pd.read_csv('./data/raw/test_data.csv', header=None, dtype=float).values
    print("done.")
